...
set_property PACKAGE_PIN U16 [get_ports {outRandomGeneratorTEST[0]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {outRandomGeneratorTEST[0]}] 
set_property PACKAGE_PIN E19 [get_ports {outRandomGeneratorTEST[1]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {outRandomGeneratorTEST[1]}] 
set_property PACKAGE_PIN U19 [get_ports {outRandomGeneratorTEST[2]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {outRandomGeneratorTEST[2]}] 
set_property PACKAGE_PIN V19 [get_ports {outRandomGeneratorTEST[3]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {outRandomGeneratorTEST[3]}] 
 	
 	set_property PACKAGE_PIN V14 [get_ports {output1TEST}]  	 	 	 	 
          set_property IOSTANDARD LVCMOS33 [get_ports {output1TEST}] 
 	
 	set_property PACKAGE_PIN P3 [get_ports {key_valueTEST[0]}]  	 	 	 	 
          set_property IOSTANDARD LVCMOS33 [get_ports {key_valueTEST[0]}] 
     set_property PACKAGE_PIN N3 [get_ports {key_valueTEST[1]}]                      
          set_property IOSTANDARD LVCMOS33 [get_ports {key_valueTEST[1]}] 
     set_property PACKAGE_PIN P1 [get_ports {key_valueTEST[2]}]                      
          set_property IOSTANDARD LVCMOS33 [get_ports {key_valueTEST[2]}] 
     set_property PACKAGE_PIN L1 [get_ports {key_valueTEST[3]}]                                   
         set_property IOSTANDARD LVCMOS33 [get_ports {key_valueTEST[3]}] 
