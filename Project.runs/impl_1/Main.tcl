...
set rc [catch {
  ...
  set_property ip_repo_paths f:/Project/Project.cache/ip [current_project]
  set_property ip_output_repo f:/Project/Project.cache/ip [current_project]
  add_files -quiet F:/Project/Project.runs/synth_1/Main.dcp
  read_xdc F:/Project/Project.srcs/constrs_1/new/cons.xdc
  link_design -top Main -part xc7a35tftg256-1
